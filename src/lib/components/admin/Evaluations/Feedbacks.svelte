<script lang="ts">
	...
	const shareHandler = async () => {
		toast.success($i18n.t('Redirecting you to AirlocAI Community'));
...
{:else}
	...
	{#if items.length > 0 && $config?.features?.enable_community_sharing}
				...
				>
					...
					>
						<div class=" self-center mr-2 font-medium line-clamp-1">
							{$i18n.t('Share to AirlocAI Community')}
						</div>
